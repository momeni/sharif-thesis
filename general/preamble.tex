...
\usepackage{bidipoem} % for traditionalpoem environment

%% customize dictum format:
\setkomafont{dictumtext}{\itshape\small\color{gray}}
\setkomafont{dictumauthor}{\normalfont}
\renewcommand*\raggeddictum{\raggedleft}
\renewcommand*\dictumwidth{0.4\linewidth}
\renewcommand*\dictumauthorformat[1]{\centering\rl{--- #1}}
